...
<div class="visualization-container">
  <div class="vis-header">
    <span class="vis-label">// Signal-to-Noise Ratio by Level</span>
    <span class="vis-sublabel">The Three Depths framework applied to information quality</span>
  </div>
  <svg viewBox="0 0 600 380" aria-label="Three-level diagram showing signal and noise distribution across levels">
    <!-- Background grid -->
    <line x1="50" y1="50" x2="550" y2="50" stroke="#1a1a24" stroke-width="1"/>
    <line x1="50" y1="130" x2="550" y2="130" stroke="#1a1a24" stroke-width="1"/>
    <line x1="50" y1="210" x2="550" y2="210" stroke="#1a1a24" stroke-width="1"/>
    <line x1="50" y1="290" x2="550" y2="290" stroke="#1a1a24" stroke-width="1"/>
    
    <!-- Level 3: Foam (top) -->
    <rect x="50" y="60" width="500" height="60" rx="4" fill="#12121a" stroke="#ef4444" stroke-width="2"/>
    <text x="70" y="85" fill="#ef4444" font-size="14" font-family="JetBrains Mono, monospace" font-weight="bold">LEVEL 3 — Speculative Narrative</text>
    <text x="70" y="105" fill="#71717a" font-size="10" font-family="JetBrains Mono, monospace">The Foam</text>
    
    <!-- Noise representation for Level 3 -->
    <circle cx="450" cy="90" r="15" fill="#ef4444" opacity="0.8"/>
    <circle cx="480" cy="75" r="12" fill="#ef4444" opacity="0.6"/>
    <circle cx="430" cy="80" r="10" fill="#ef4444" opacity="0.7"/>
    <circle cx="500" cy="95" r="8" fill="#ef4444" opacity="0.5"/>
    <text x="300" y="90" fill="#71717a" font-size="9" font-family="JetBrains Mono, monospace" text-anchor="middle">90% NOISE</text>
    <text x="300" y="105" fill="#ef4444" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="middle">10% SIGNAL (buried)</text>
    
    <!-- Arrow down from Level 3 -->
    <path d="M300 125 L300 135" stroke="#3a3a4a" stroke-width="2"/>
    <polygon points="300,140 295,130 305,130" fill="#3a3a4a"/>
    
    <!-- Level 2: Deep Current (middle) -->
    <rect x="50" y="140" width="500" height="60" rx="4" fill="#12121a" stroke="#a78bfa" stroke-width="2"/>
    <text x="70" y="165" fill="#a78bfa" font-size="14" font-family="JetBrains Mono, monospace" font-weight="bold">LEVEL 2 — Structural Pattern</text>
    <text x="70" y="185" fill="#71717a" font-size="10" font-family="JetBrains Mono, monospace">The Deep Current</text>
    
    <!-- Mixed representation for Level 2 -->
    <circle cx="440" cy="170" r="18" fill="#a78bfa" opacity="0.4"/>
    <circle cx="470" cy="170" r="12" fill="#a78bfa" opacity="0.3"/>
    <circle cx="420" cy="170" r="8" fill="#a78bfa" opacity="0.5"/>
    <circle cx="500" cy="170" r="6" fill="#a78bfa" opacity="0.3"/>
    <text x="300" y="170" fill="#71717a" font-size="9" font-family="JetBrains Mono, monospace" text-anchor="middle">50% SIGNAL / 50% NOISE</text>
    <text x="300" y="185" fill="#a78bfa" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="middle">Requires interpretation — can be falsified</text>
    
    <!-- Arrow down from Level 2 -->
    <path d="M300 205 L300 215" stroke="#3a3a4a" stroke-width="2"/>
    <polygon points="300,220 295,210 305,210" fill="#3a3a4a"/>
    
    <!-- Level 1: Bedrock (bottom) -->
    <rect x="50" y="220" width="500" height="60" rx="4" fill="#12121a" stroke="#22d3ee" stroke-width="2"/>
    <text x="70" y="245" fill="#22d3ee" font-size="14" font-family="JetBrains Mono, monospace" font-weight="bold">LEVEL 1 — Documented</text>
    <text x="70" y="265" fill="#71717a" font-size="10" font-family="JetBrains Mono, monospace">The Bedrock</text>
    
    <!-- Signal representation for Level 1 -->
    <circle cx="440" cy="250" r="18" fill="#22d3ee" opacity="0.6"/>
    <circle cx="470" cy="250" r="12" fill="#22d3ee" opacity="0.4"/>
    <circle cx="420" cy="250" r="8" fill="#22d3ee" opacity="0.5"/>
    <circle cx="500" cy="250" r="6" fill="#22d3ee" opacity="0.3"/>
    <text x="300" y="250" fill="#22d3ee" font-size="9" font-family="JetBrains Mono, monospace" text-anchor="middle">90% SIGNAL</text>
    <text x="300" y="265" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="middle">10% gap (fragmentary, requires patience)</text>
    
    <!-- Labels for what belongs at each level -->
    <text x="570" y="90" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="end">Billy Carson, X threads,</text>
    <text x="570" y="102" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="end">AI-generated conspiracies</text>
    
    <text x="570" y="170" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="end">Apkallu-as-agents,</text>
    <text x="570" y="182" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="end">ME-as-weights, structural rhyme</text>
    
    <text x="570" y="250" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="end">ETCSL corpus,</text>
    <text x="570" y="262" fill="#71717a" font-size="8" font-family="JetBrains Mono, monospace" text-anchor="end">actual seals, FOIA documents</text>
    
    <!-- The Flood metaphor -->
    <rect x="50" y="310" width="500" height="30" rx="2" fill="#0a0a0f" stroke="#fbbf24" stroke-width="1"/>
    <text x="300" y="330" fill="#fbbf24" font-size="11" font-family="JetBrains Mono, monospace" text-anchor="middle">THE FLOOD: All signal must pass through the noise to reach us</text>
  </svg>
  <div class="vis-footnote">
    The modern information environment does not discriminate. All three levels flow through the same channels, making Level 1 skills essential for survival.
  </div>
</div>
